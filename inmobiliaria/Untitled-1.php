...
$query_resultados = "SELECT ref_interna, tipo, dormitorios, m2_construidos, precio, foto1, provincia, localidad, zona_o_barrio FROM inmuebles";
...
<table border="1">
  ...
  <?php do { ?>
    <tr>
      <td><?php echo $row_resultados['ref_interna']; ?></td>
      ...
      <td><?php echo $row_resultados['foto1']; ?></td>
